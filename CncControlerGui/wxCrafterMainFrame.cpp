...
MainFrameDummyBase::MainFrameDummyBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    SetName(wxT("MainFrameDummyBase"));
    SetSize(500,300);
    if (GetSizer()) {
         GetSizer()->Fit(this);
    }
...
MainFrameDummyBase::~MainFrameDummyBase()
{
}
    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_manuallyMoveCoordPlaceholder = new wxPanel(m_mainBookManual, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_mainBookManual, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_manuallyMoveCoordPlaceholder->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    
    flexGridSizer862->Add(m_manuallyMoveCoordPlaceholder, 0, wxALL|wxEXPAND, WXC_FROM_DIP(0));
    ...
    m_staticText128313 = new wxStaticText(m_controllerPinReport, wxID_ANY, _("Controller Pin Report:"), wxDefaultPosition, wxDLG_UNIT(m_controllerPinReport, wxSize(-1,-1)), 0);
    ...
    m_btnOrigin = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("snap-orto")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_btnRuler = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("ruler2")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_btnHelpLines = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("view-grid")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_btnBoundBox = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("cube_green")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_btnPosMarker = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("16-marker")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_btnFlyPath = new wxBitmapToggleButton(m_motionMonitor, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("link_editor")), wxDefaultPosition, wxDLG_UNIT(m_motionMonitor, wxSize(26,26)), 0);
    ...
    m_conrollerMessages = new wxPanel(m_listbookMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_listbookMonitor, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    int m_conrollerMessagesImgIndex;
    m_conrollerMessagesImgIndex = m_listbookMonitor_il->Add(wxXmlResource::Get()->LoadBitmap(wxT("16-archive")));
    m_listbookMonitor->AddPage(m_conrollerMessages, _("Controller\nMessages"), false, m_conrollerMessagesImgIndex);
    ...
    m_controllerMsgHistoryPlaceholder = new wxTextCtrl(m_conrollerMessages, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_conrollerMessages, wxSize(-1,-1)), wxTE_RICH|wxTE_READONLY|wxTE_MULTILINE|wxTE_DONTWRAP|wxHSCROLL|wxVSCROLL);
    ...
    flexGridSizer6214->Add(m_scrollWin7361, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    ...
    m_MarkSerialSpy = new wxButton(m_serialSpyView, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_serialSpyView, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_clearSerialSpy = new wxButton(m_serialSpyView, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_serialSpyView, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_cbSerialSpyMode = new wxComboBox(m_serialSpyView, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_serialSpyView, wxSize(-1,-1)), m_cbSerialSpyModeArr, wxCB_READONLY);
    ...
    wxFlexGridSizer* flexGridSizer4706 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer4706->SetFlexibleDirection( wxBOTH );
    flexGridSizer4706->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    
    flexGridSizer27302->Add(flexGridSizer4706, 1, wxALL|wxEXPAND|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_clearSerialSpyOnConnect = new wxBitmapToggleButton(m_serialSpyView, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("brick-delete")), wxDefaultPosition, wxDLG_UNIT(m_serialSpyView, wxSize(26,26)), 0);
    ...
    m_clearSerialSpyBeforNextRun = new wxBitmapToggleButton(m_serialSpyView, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("script-delete")), wxDefaultPosition, wxDLG_UNIT(m_serialSpyView, wxSize(26,26)), 0);
    ...
    wxFlexGridSizer* flexGridSizer4704 = new wxFlexGridSizer(1, 1, 0, 0);
    ...
    wxFlexGridSizer* flexGridSizer3833 = new wxFlexGridSizer(2, 1, 0, 0);
    ...
    m_serialSpyPlaceholder->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_INFOBK));
    ...
    flexGridSizer3833->Add(m_sypDetailsBook, 0, wxALL|wxEXPAND, WXC_FROM_DIP(0));
    
    m_unknownPanel = new wxPanel(m_sypDetailsBook, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_sypDetailsBook, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_sypDetailsBook->AddPage(m_unknownPanel, _("Page"), false);
    
    wxFlexGridSizer* flexGridSizer7220 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7220->SetFlexibleDirection( wxBOTH );
    flexGridSizer7220->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7220->AddGrowableCol(1);
    flexGridSizer7220->AddGrowableRow(0);
    m_unknownPanel->SetSizer(flexGridSizer7220);
    
    wxFlexGridSizer* flexGridSizer7241 = new wxFlexGridSizer(3, 1, 0, 0);
    flexGridSizer7241->SetFlexibleDirection( wxBOTH );
    flexGridSizer7241->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    
    flexGridSizer7220->Add(flexGridSizer7241, 0, wxALL, WXC_FROM_DIP(2));
    
    m_staticText72374 = new wxStaticText(m_unknownPanel, wxID_ANY, _("Details:"), wxDefaultPosition, wxDLG_UNIT(m_unknownPanel, wxSize(-1,-1)), 0);
    wxFont m_staticText72374Font(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_staticText72374->SetFont(m_staticText72374Font);
    
    flexGridSizer7241->Add(m_staticText72374, 0, wxALL, WXC_FROM_DIP(1));
    
    m_lnUnkonwnDetails = new wxTextCtrl(m_unknownPanel, wxID_ANY, wxT("3333338"), wxDefaultPosition, wxDLG_UNIT(m_unknownPanel, wxSize(45,-1)), wxTE_READONLY|wxBORDER_NONE);
    wxFont m_lnUnkonwnDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Segoe UI"));
    m_lnUnkonwnDetails->SetFont(m_lnUnkonwnDetailsFont);
    #if wxVERSION_NUMBER >= 3000
    m_lnUnkonwnDetails->SetHint(wxT(""));
    #endif
    
    flexGridSizer7241->Add(m_lnUnkonwnDetails, 0, wxALL, WXC_FROM_DIP(0));
    m_lnUnkonwnDetails->SetMinSize(wxSize(45,-1));
    
    m_staticBitmap7230 = new wxStaticBitmap(m_unknownPanel, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("24-info")), wxDefaultPosition, wxDLG_UNIT(m_unknownPanel, wxSize(-1,-1)), 0 );
    
    flexGridSizer7241->Add(m_staticBitmap7230, 0, wxALL, WXC_FROM_DIP(5));
    
    wxFlexGridSizer* flexGridSizer7559 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7559->SetFlexibleDirection( wxBOTH );
    flexGridSizer7559->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7559->AddGrowableCol(0);
    flexGridSizer7559->AddGrowableRow(0);
    
    flexGridSizer7220->Add(flexGridSizer7559, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyUnknownDetails = new wxDataViewListCtrl(m_unknownPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_unknownPanel, wxSize(-1,60)), wxDV_VERT_RULES|wxDV_ROW_LINES|wxDV_SINGLE);
    m_spyUnknownDetails->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNTEXT));
    m_spyUnknownDetails->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
    wxFont m_spyUnknownDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_spyUnknownDetails->SetFont(m_spyUnknownDetailsFont);
    
    flexGridSizer7559->Add(m_spyUnknownDetails, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyUnknownDetails->AppendTextColumn(_("Info"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyUnknownDetails->SetMinSize(wxSize(-1,60));
    
    m_btOpenSpyDetailWindow = new wxButton(m_unknownPanel, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_unknownPanel, wxSize(26, 60)), 0);
    #if wxVERSION_NUMBER >= 2904
    m_btOpenSpyDetailWindow->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("document-open-6")), wxLEFT);
    m_btOpenSpyDetailWindow->SetBitmapMargins(2,2);
    #endif
    m_btOpenSpyDetailWindow->SetToolTip(_("Open bigger window"));
    
    flexGridSizer7559->Add(m_btOpenSpyDetailWindow, 0, wxALL, WXC_FROM_DIP(0));
    m_btOpenSpyDetailWindow->SetMinSize(wxSize(26,60));
    
    m_inboundPanel = new wxPanel(m_sypDetailsBook, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_sypDetailsBook, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_sypDetailsBook->AddPage(m_inboundPanel, _("Page"), false);
    
    wxFlexGridSizer* flexGridSizer7212 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7212->SetFlexibleDirection( wxBOTH );
    flexGridSizer7212->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7212->AddGrowableCol(1);
    flexGridSizer7212->AddGrowableRow(0);
    m_inboundPanel->SetSizer(flexGridSizer7212);
    
    wxFlexGridSizer* flexGridSizer7238 = new wxFlexGridSizer(3, 1, 0, 0);
    flexGridSizer7238->SetFlexibleDirection( wxBOTH );
    flexGridSizer7238->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    
    flexGridSizer7212->Add(flexGridSizer7238, 0, wxALL, WXC_FROM_DIP(2));
    
    m_staticText72373 = new wxStaticText(m_inboundPanel, wxID_ANY, _("Details:"), wxDefaultPosition, wxDLG_UNIT(m_inboundPanel, wxSize(-1,-1)), 0);
    wxFont m_staticText72373Font(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_staticText72373->SetFont(m_staticText72373Font);
    
    flexGridSizer7238->Add(m_staticText72373, 0, wxALL, WXC_FROM_DIP(1));
    
    m_lnInboundDetails = new wxTextCtrl(m_inboundPanel, wxID_ANY, wxT("3333338"), wxDefaultPosition, wxDLG_UNIT(m_inboundPanel, wxSize(45,-1)), wxTE_READONLY|wxBORDER_NONE);
    wxFont m_lnInboundDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Segoe UI"));
    m_lnInboundDetails->SetFont(m_lnInboundDetailsFont);
    #if wxVERSION_NUMBER >= 3000
    m_lnInboundDetails->SetHint(wxT(""));
    #endif
    
    flexGridSizer7238->Add(m_lnInboundDetails, 0, wxALL, WXC_FROM_DIP(0));
    m_lnInboundDetails->SetMinSize(wxSize(45,-1));
    
    m_staticBitmap7232 = new wxStaticBitmap(m_inboundPanel, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("24-undo")), wxDefaultPosition, wxDLG_UNIT(m_inboundPanel, wxSize(-1,-1)), 0 );
    
    flexGridSizer7238->Add(m_staticBitmap7232, 0, wxALL, WXC_FROM_DIP(5));
    
    wxFlexGridSizer* flexGridSizer7565 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7565->SetFlexibleDirection( wxBOTH );
    flexGridSizer7565->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7565->AddGrowableCol(0);
    flexGridSizer7565->AddGrowableRow(0);
    
    flexGridSizer7212->Add(flexGridSizer7565, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyInboundDetails = new wxDataViewListCtrl(m_inboundPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_inboundPanel, wxSize(-1,55)), wxDV_VERT_RULES|wxDV_ROW_LINES|wxDV_SINGLE);
    m_spyInboundDetails->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNTEXT));
    m_spyInboundDetails->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
    wxFont m_spyInboundDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_spyInboundDetails->SetFont(m_spyInboundDetailsFont);
    
    flexGridSizer7565->Add(m_spyInboundDetails, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyInboundDetails->AppendTextColumn(_("Context"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyInboundDetails->AppendTextColumn(_("Command [CMD]"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyInboundDetails->AppendTextColumn(_("Process ID [PID]"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyInboundDetails->AppendTextColumn(_("Index"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyInboundDetails->AppendTextColumn(_("Data"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyInboundDetails->SetMinSize(wxSize(-1,55));
    
    m_button75612 = new wxButton(m_inboundPanel, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_inboundPanel, wxSize(26, 60)), 0);
    #if wxVERSION_NUMBER >= 2904
    m_button75612->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("document-open-6")), wxLEFT);
    m_button75612->SetBitmapMargins(2,2);
    #endif
    m_button75612->SetToolTip(_("Open bigger window"));
    
    flexGridSizer7565->Add(m_button75612, 0, wxALL, WXC_FROM_DIP(0));
    m_button75612->SetMinSize(wxSize(26,60));
    
    m_outbundPanel = new wxPanel(m_sypDetailsBook, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_sypDetailsBook, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_sypDetailsBook->AddPage(m_outbundPanel, _("Page"), false);
    
    wxFlexGridSizer* flexGridSizer7214 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7214->SetFlexibleDirection( wxBOTH );
    flexGridSizer7214->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7214->AddGrowableCol(1);
    flexGridSizer7214->AddGrowableRow(0);
    m_outbundPanel->SetSizer(flexGridSizer7214);
    
    wxFlexGridSizer* flexGridSizer7235 = new wxFlexGridSizer(3, 1, 0, 0);
    flexGridSizer7235->SetFlexibleDirection( wxBOTH );
    flexGridSizer7235->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    
    flexGridSizer7214->Add(flexGridSizer7235, 0, wxALL, WXC_FROM_DIP(2));
    
    m_staticText7237 = new wxStaticText(m_outbundPanel, wxID_ANY, _("Details:"), wxDefaultPosition, wxDLG_UNIT(m_outbundPanel, wxSize(-1,-1)), 0);
    wxFont m_staticText7237Font(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_staticText7237->SetFont(m_staticText7237Font);
    
    flexGridSizer7235->Add(m_staticText7237, 0, wxALL, WXC_FROM_DIP(1));
    
    m_lnOutboundDetails = new wxTextCtrl(m_outbundPanel, wxID_ANY, wxT("3333338"), wxDefaultPosition, wxDLG_UNIT(m_outbundPanel, wxSize(45,-1)), wxTE_READONLY|wxBORDER_NONE);
    wxFont m_lnOutboundDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Segoe UI"));
    m_lnOutboundDetails->SetFont(m_lnOutboundDetailsFont);
    #if wxVERSION_NUMBER >= 3000
    m_lnOutboundDetails->SetHint(wxT(""));
    #endif
    
    flexGridSizer7235->Add(m_lnOutboundDetails, 0, wxALL, WXC_FROM_DIP(0));
    m_lnOutboundDetails->SetMinSize(wxSize(45,-1));
    
    m_staticBitmap7234 = new wxStaticBitmap(m_outbundPanel, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("24-redo")), wxDefaultPosition, wxDLG_UNIT(m_outbundPanel, wxSize(-1,-1)), 0 );
    
    flexGridSizer7235->Add(m_staticBitmap7234, 0, wxALL, WXC_FROM_DIP(5));
    
    wxFlexGridSizer* flexGridSizer7562 = new wxFlexGridSizer(1, 2, 0, 0);
    flexGridSizer7562->SetFlexibleDirection( wxBOTH );
    flexGridSizer7562->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer7562->AddGrowableCol(0);
    flexGridSizer7562->AddGrowableRow(0);
    
    flexGridSizer7214->Add(flexGridSizer7562, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyOutboundDetails = new wxDataViewListCtrl(m_outbundPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_outbundPanel, wxSize(-1,55)), wxDV_VERT_RULES|wxDV_ROW_LINES|wxDV_SINGLE);
    m_spyOutboundDetails->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNTEXT));
    m_spyOutboundDetails->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
    wxFont m_spyOutboundDetailsFont(7, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_spyOutboundDetails->SetFont(m_spyOutboundDetailsFont);
    
    flexGridSizer7562->Add(m_spyOutboundDetails, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_spyOutboundDetails->AppendTextColumn(_("Context"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyOutboundDetails->AppendTextColumn(_("Command [CMD]"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyOutboundDetails->AppendTextColumn(_("Portion"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyOutboundDetails->AppendTextColumn(_("Data"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT);
    m_spyOutboundDetails->SetMinSize(wxSize(-1,55));
    
    m_button75611 = new wxButton(m_outbundPanel, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_outbundPanel, wxSize(26, 60)), 0);
    #if wxVERSION_NUMBER >= 2904
    m_button75611->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("document-open-6")), wxLEFT);
    m_button75611->SetBitmapMargins(2,2);
    #endif
    m_button75611->SetToolTip(_("Open bigger window"));
    
    flexGridSizer7562->Add(m_button75611, 0, wxALL, WXC_FROM_DIP(0));
    m_button75611->SetMinSize(wxSize(26,60));
    ...
    wxFlexGridSizer* flexGridSizer7498 = new wxFlexGridSizer(2, 1, 0, 0);
    ...
    m_panel7502 = new wxPanel(m_notebookSpeedMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookSpeedMonitor, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    int m_panel7502ImgIndex;
    m_panel7502ImgIndex = m_notebookSpeedMonitor_il->Add(wxXmlResource::Get()->LoadBitmap(wxT("application-side-list")));
    m_notebookSpeedMonitor->AddPage(m_panel7502, _("P"), false, m_panel7502ImgIndex);
    ...
    m_panel7502->SetSizer(flexGridSizer4480);
    ...
    m_btTogglePosSpy = new wxBitmapToggleButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("16-connected")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(26,26)), 0);
    ...
    m_btCopyPosSpy = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("edit-copy-7")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(26,26)), wxBU_AUTODRAW);
    ...
    m_btSearchPosSpy = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("system-search-2")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(26,26)), wxBU_AUTODRAW);
    ...
    m_btClearPositionSpy = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("16-clean")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(26,26)), wxBU_AUTODRAW);
    ...
    m_cbContentPosSpy = new wxComboBox(m_panel7502, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(-1,-1)), m_cbContentPosSpyArr, wxCB_READONLY);
    ...
    m_staticText4526 = new wxStaticText(m_panel7502, wxID_ANY, _("(lightly async)"), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(-1,12)), 0);
    ...
    m_positionSpyCount = new wxTextCtrl(m_panel7502, wxID_ANY, wxT("0"), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(-1,12)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    ...
    m_positionSpy = new wxListCtrl(m_panel7502, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(-1,-1)), wxLC_VIRTUAL|wxLC_REPORT);
    ...
    m_bmpButton47181 = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("go-first-view")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(24,24)), wxBU_AUTODRAW);
    ...
    m_bmpButton4718 = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("go-last-view")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(24,24)), wxBU_AUTODRAW);
    ...
    m_bmpButton47182 = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("go-up-7")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(24,24)), wxBU_AUTODRAW);
    ...
    m_bmpButton47183 = new wxBitmapButton(m_panel7502, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("go-down-7")), wxDefaultPosition, wxDLG_UNIT(m_panel7502, wxSize(24,24)), wxBU_AUTODRAW);
    ...
    m_panel7504 = new wxPanel(m_notebookSpeedMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookSpeedMonitor, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    int m_panel7504ImgIndex;
    m_panel7504ImgIndex = m_notebookSpeedMonitor_il->Add(wxXmlResource::Get()->LoadBitmap(wxT("sports-shuttlecock")));
    m_notebookSpeedMonitor->AddPage(m_panel7504, _("F"), false, m_panel7504ImgIndex);
    ...
    m_panel7504->SetSizer(flexGridSizer7506);
    
    m_speedMonitorPlaceholder = new wxPanel(m_panel7504, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel7504, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    flexGridSizer7498->Add(m_speedPanel, 0, wxALL|wxEXPAND, WXC_FROM_DIP(0));
    ...
    wxFlexGridSizer* flexGridSizer8248 = new wxFlexGridSizer(4, 1, 0, 0);
    ...
    flexGridSizer8248->AddGrowableRow(3);
    m_secureRunPanel->SetSizer(flexGridSizer8248);
    
    wxFlexGridSizer* flexGridSizer8251 = new wxFlexGridSizer(1, 3, 0, 0);
    ...
    m_secToolbar = new wxPanel(m_secureRunPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_secureRunPanel, wxSize(-1,30)), wxTAB_TRAVERSAL);
    ...
    m_splitterPageMonitor->SetSizer(flexGridSizer8263);
    
    wxFlexGridSizer* flexGridSizer8329 = new wxFlexGridSizer(1, 2, 0, 0);
    ...
    m_secMonitorPlaceholder = new wxPanel(m_splitterPageMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_secZViewPlaceholder = new wxPanel(m_splitterPageMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(50,-1)), wxTAB_TRAVERSAL);
    m_secZViewPlaceholder->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    
    flexGridSizer8329->Add(m_secZViewPlaceholder, 0, wxALL|wxEXPAND, WXC_FROM_DIP(0));
    m_secZViewPlaceholder->SetMinSize(wxSize(50,-1));
    ...
    m_3D_TopSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_BottomSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_FrontSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_RearSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(24,24)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_RearSec->SetMinSize(wxSize(24,24));
    
    m_3D_LeftSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_RightSec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_staticLine348317 = new wxStaticLine(m_splitterPageMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(-1,-1)), wxLI_HORIZONTAL);
    
    flexGridSizer23118->Add(m_staticLine348317, 0, wxALL|wxEXPAND, WXC_FROM_DIP(2));
    
    m_3D_Perspective1Sec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), wxBORDER_THEME);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_Perspective2Sec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_Perspective3Sec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_3D_Perspective4Sec = new wxButton(m_splitterPageMonitor, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(26,26)), 0);
    #if wxVERSION_NUMBER >= 2904
    ...
    m_staticLine234122 = new wxStaticLine(m_splitterPageMonitor, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageMonitor, wxSize(-1,-1)), wxLI_HORIZONTAL);
    ...
    if(!wxPersistenceManager::Get().Find(m_sypDetailsBook)){
        ...
        wxPersistenceManager::Get().Restore(m_sypDetailsBook);
    }
    #endif
    ...
    m_spyUnknownDetails->Connect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyUnknownDetails), NULL, this);
    m_btOpenSpyDetailWindow->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
    m_spyInboundDetails->Connect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyInboundDetails), NULL, this);
    m_button75612->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
    m_spyOutboundDetails->Connect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyOutboundDetails), NULL, this);
    m_button75611->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
...
MainFrameBClass::~MainFrameBClass()
{
    ...
    m_spyUnknownDetails->Disconnect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyUnknownDetails), NULL, this);
    m_btOpenSpyDetailWindow->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
    m_spyInboundDetails->Disconnect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyInboundDetails), NULL, this);
    m_button75612->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
    m_spyOutboundDetails->Disconnect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, wxDataViewEventHandler(MainFrameBClass::onSelectSpyOutboundDetails), NULL, this);
    m_button75611->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrameBClass::openSpyDetailWindow), NULL, this);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText1160 = new wxStaticText(this, wxID_ANY, _("Manually Move Coordinates / Parameters:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    ...
    m_staticLine1162 = new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxLI_HORIZONTAL);
    ...
    wxFlexGridSizer* flexGridSizer5099 = new wxFlexGridSizer(3, 1, 0, 0);
    ...
    m_staticText83998 = new wxStaticText(this, wxID_ANY, _("Speed"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    flexGridSizer8555->Add(m_staticText83998, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_staticText8399 = new wxStaticText(this, wxID_ANY, _("[mm/min]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxALIGN_RIGHT);
    
    flexGridSizer8555->Add(m_staticText8399, 0, wxALL|wxEXPAND|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    wxFlexGridSizer* flexGridSizer5111 = new wxFlexGridSizer(3, 1, 0, 0);
    ...
    flexGridSizer5111->AddGrowableRow(1);
    
    flexGridSizer5099->Add(flexGridSizer5111, 0, wxALL|wxEXPAND, WXC_FROM_DIP(0));
    
    flexGridSizer5111->Add(0, 2, 1, wxALL, WXC_FROM_DIP(0));
    
    wxFlexGridSizer* flexGridSizer8404 = new wxFlexGridSizer(1, 3, 0, 0);
    flexGridSizer8404->SetFlexibleDirection( wxBOTH );
    flexGridSizer8404->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
    flexGridSizer8404->AddGrowableCol(1);
    flexGridSizer8404->AddGrowableRow(0);
    
    flexGridSizer5111->Add(flexGridSizer8404, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_staticText5105 = new wxStaticText(this, wxID_ANY, _("Value:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    flexGridSizer8404->Add(m_staticText5105, 0, wxALL, WXC_FROM_DIP(1));
    
    m_manuallySpeedSlider = new wxSlider(this, wxID_ANY, 80, 1, 100, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxSL_HORIZONTAL);
    
    flexGridSizer8404->Add(m_manuallySpeedSlider, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    
    m_manuallySpeedValue = new wxTextCtrl(this, wxID_ANY, wxT("500.0"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(50,20)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    wxFont m_manuallySpeedValueFont(9, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_manuallySpeedValue->SetFont(m_manuallySpeedValueFont);
    #if wxVERSION_NUMBER >= 3000
    m_manuallySpeedValue->SetHint(wxT(""));
    #endif
    
    flexGridSizer8404->Add(m_manuallySpeedValue, 0, wxALL|wxEXPAND, WXC_FROM_DIP(1));
    ...
    m_staticText85409 = new wxStaticText(this, wxID_ANY, _("Max."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText85409, 0, wxALL|wxALIGN_LEFT, WXC_FROM_DIP(1));
    
    m_staticText8540 = new wxStaticText(this, wxID_ANY, _("F [X]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText8540, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_staticText8542 = new wxStaticText(this, wxID_ANY, _("F [Y]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText8542, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_staticText8544 = new wxStaticText(this, wxID_ANY, _("F [Z]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText8544, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_staticText8546 = new wxStaticText(this, wxID_ANY, _("F [XY]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText8546, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_staticText8548 = new wxStaticText(this, wxID_ANY, _("F [XYZ]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    gridSizer8538->Add(m_staticText8548, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    
    m_staticText8563 = new wxStaticText(this, wxID_ANY, _("[mm/min]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxALIGN_RIGHT);
    
    gridSizer8538->Add(m_staticText8563, 0, wxLEFT|wxTOP|wxBOTTOM, WXC_FROM_DIP(1));
    
    m_fxMax = new wxTextCtrl(this, wxID_ANY, wxT("1234,5"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(44,-1)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    m_fxMax->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    wxFont m_fxMaxFont(8, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_fxMax->SetFont(m_fxMaxFont);
    #if wxVERSION_NUMBER >= 3000
    m_fxMax->SetHint(wxT(""));
    #endif
    
    gridSizer8538->Add(m_fxMax, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    m_fxMax->SetMinSize(wxSize(44,-1));
    
    m_fyMax = new wxTextCtrl(this, wxID_ANY, wxT("1234,5"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(44,-1)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    m_fyMax->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    wxFont m_fyMaxFont(8, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_fyMax->SetFont(m_fyMaxFont);
    #if wxVERSION_NUMBER >= 3000
    m_fyMax->SetHint(wxT(""));
    #endif
    
    gridSizer8538->Add(m_fyMax, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    m_fyMax->SetMinSize(wxSize(44,-1));
    
    m_fzMax = new wxTextCtrl(this, wxID_ANY, wxT("1234,5"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(44,-1)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    m_fzMax->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    wxFont m_fzMaxFont(8, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_fzMax->SetFont(m_fzMaxFont);
    #if wxVERSION_NUMBER >= 3000
    m_fzMax->SetHint(wxT(""));
    #endif
    
    gridSizer8538->Add(m_fzMax, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    m_fzMax->SetMinSize(wxSize(44,-1));
    
    m_fxyMax = new wxTextCtrl(this, wxID_ANY, wxT("1234,5"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(44,-1)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    m_fxyMax->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    wxFont m_fxyMaxFont(8, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_fxyMax->SetFont(m_fxyMaxFont);
    #if wxVERSION_NUMBER >= 3000
    m_fxyMax->SetHint(wxT(""));
    #endif
    
    gridSizer8538->Add(m_fxyMax, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    m_fxyMax->SetMinSize(wxSize(44,-1));
    
    m_fxyzMax = new wxTextCtrl(this, wxID_ANY, wxT("1234,5"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(44,-1)), wxTE_RIGHT|wxTE_READONLY|wxBORDER_NONE);
    m_fxyzMax->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
    wxFont m_fxyzMaxFont(8, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Segoe UI"));
    m_fxyzMax->SetFont(m_fxyzMaxFont);
    #if wxVERSION_NUMBER >= 3000
    m_fxyzMax->SetHint(wxT(""));
    #endif
    
    gridSizer8538->Add(m_fxyzMax, 0, wxALL|wxALIGN_RIGHT, WXC_FROM_DIP(1));
    m_fxyzMax->SetMinSize(wxSize(44,-1));
    ...
    wxFlexGridSizer* flexGridSizer8580 = new wxFlexGridSizer(0, 1, 0, 0);
    ...
    // Connect events
    m_manuallySpeedSlider->Connect(wxEVT_SCROLL_CHANGED, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_manuallySpeedSlider->Connect(wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_manuallySpeedSlider->Connect(wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_fxMax->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fyMax->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fzMax->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fxyMax->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fxyzMax->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
...
{
    m_manuallySpeedSlider->Disconnect(wxEVT_SCROLL_CHANGED, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_manuallySpeedSlider->Disconnect(wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_manuallySpeedSlider->Disconnect(wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler(CncManuallyMoveCoordinatesBase::changeManuallySpeedSlider), NULL, this);
    m_fxMax->Disconnect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fyMax->Disconnect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fzMax->Disconnect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fxyMax->Disconnect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
    m_fxyzMax->Disconnect(wxEVT_LEFT_DOWN, wxMouseEventHandler(CncManuallyMoveCoordinatesBase::onLBDownMax), NULL, this);
